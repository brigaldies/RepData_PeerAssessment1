...
With the missing data backfilled, the new mean and median of the total number of steps per day are **`r steps_mean_formatted`** and **`r steps_median_formatted`** respectively. By comparison with the original mean **`r steps_mean_no_na_formatted`** and median **`r steps_median_no_na_formatted`** with the missing data removed, the following observations are made:
