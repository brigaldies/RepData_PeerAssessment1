...
The rounded mean and median of the total number of steps per day are **`r steps_mean_formatted`** and **`r steps_median_formatted`** respectively.
...
With the missing data backfilled, the rounded calculated mean and median of the total number of steps per day are **`r steps_mean_formatted`** and **`r steps_median_formatted`** respectively. By the mathematical nature of the backfilling strategy and the missing data itself (Whole days are missing the steps in all intervals), the new mean is unchanged. However, with the addition of data points, the median changed a bit.
...
Figure `r fig_num` plots the time series of the 5-minute interval (x-axis) and the average number of steps taken, averaged across all days (y-axis), on two vertical panels to compare between week days and weekend days.
